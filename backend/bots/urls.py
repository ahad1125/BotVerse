...
from .views import (BotViewSet,KnowledgeSourceViewSet,ConversationListView,ChatView,QuickViewViewSet,PublicBotInfoView,BotQRCodeView,ConversationMessagesView,PublicQuickRepliesView,LeadViewSet)
...
path(
    "bots/<uuid:bot_pk>/leads/<uuid:pk>/",
    LeadViewSet.as_view({
        "get": "retrieve",
        "delete": "destroy",
    }),
